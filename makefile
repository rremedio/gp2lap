...
OBJS=	$(OUTDIR)\gp2lap.obj $(OUTDIR)\gp2hook.obj $(OUTDIR)\gp2log.obj			\
		 ...
		 $(OUTDIR)\prflog.obj $(OUTDIR)\cartex.obj $(OUTDIR)\aiaccel.obj $(OUTDIR)\carshape.obj $(OUTDIR)\pitstops.obj $(OUTDIR)\teamphys.obj $(OUTDIR)\override.obj $(OUTDIR)\drvdata.obj $(OUTDIR)\pitcrew.obj $(OUTDIR)\gridcap.obj
